...
class CustomUser(AbstractUser):
    ...
    wallet = models.DecimalField(max_digits=50, default=Decimal("0.00"))
    choices = (
        ("User", "User"),
        ("Agent", "Agent"),
...
class Payment(models.Model):
    ...
    amount = models.DecimalField(max_digits=50, null=True, blank=True)
...
class TopUpRequest(models.Model):
    ...
    amount = models.DecimalField(max_digits=50)
