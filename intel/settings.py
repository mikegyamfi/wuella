...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "DanWel Store GH",
    "site_header": "DanWel Store GH",
    # "site_logo": "img/site/bestPay Logo.png",
    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "DanWel Store GH",
    "copyright": "DanWel Store GH",
    # "login_logo": "img/site/bp.png",
    "welcome_sign": "Welcome to the DanWel Store GH Admin",
